...
public class SlaggaOnHit7s implements OnHitEffectPlugin {


	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
					  Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		Color FRINGE_COLOR = new Color(255, 133, 76, 125);
		if (!shieldHit && target instanceof ShipAPI) {
			dealArmorDamage(projectile, (ShipAPI) target, point, projectile.getDamageAmount());
			engine.addNebulaSmokeParticle(point, new Vector2f(0f, 0f), 60f, 1.4f, 0.5f, 0.5f, 0.75f, FRINGE_COLOR);
		}
	}
